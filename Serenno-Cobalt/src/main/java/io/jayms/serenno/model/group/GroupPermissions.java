...
public class GroupPermissions {
	...
	public static final String ALL = "group-all"; // master permission
	public static final String REINFORCEMENT_BYPASS = "reinforcement-bypass"; // bypass reinforcement
	public static final String REINFORCEMENT_FORTIFICATION = "reinforcement-fortification"; // fortify/reinforce reinforcements 
	public static final String REINFORCEMENT_INFORMATION = "reinforcement-information"; // get information about reinforcement
