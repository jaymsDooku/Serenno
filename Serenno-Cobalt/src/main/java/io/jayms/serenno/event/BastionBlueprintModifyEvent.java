...
public class BastionBlueprintModifyEvent extends Event {
	...
	public BastionBlueprintModifyEvent(Player player, String blueprintName, BastionBlueprint bastionBlueprint) {
		this.player = player;
