...
public class ViewBastionBlueprintEvent extends Event {
	...
	public ViewBastionBlueprintEvent(Player player, String blueprintName, BastionBlueprint bastionBlueprint) {
		this.player = player;
